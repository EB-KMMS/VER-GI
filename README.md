...
Here you can find a list of hints for each of the puzzles...

<details> 
  <summary>Puzzle 1: Histology code 1 (Jigsaw) </summary>
    Have you built the jigsaw? Review this link for histology of the tongue: https://histology.leeds.ac.uk/home/oral/tongue/ 
...
<details> 
  <summary>Puzzle 6: What was my route? (Path 1) </summary>
   From the origin of the coeliac trunk (start) the person goes down a very winding or tortuous artery. In life, this artery would head towards the spleen (a large lymphatic organ).
  <details>The word is 7, 6 letters long.
  <summary>Length</summary></details>
</details>
...
<details> 
  <summary>Puzzle 8: Portosystemic anastomosis (Choose your path) </summary>
   Use this video to help you: https://www.youtube.com/watch?v=YDY2UUmqrLg
  <details>The word is 5, 6 letters long.
  <summary>Length</summary></details>
</details>
...
<details> 
  <summary>Puzzle 11: Find the patterns (Connections) </summary>
   The four categories are: Coeliac trunk territory, SMA territory, IMA territory, secondary retroperitoneal structures. Feel free to look terms up if you haven't heard them before. Remember you need to then take each item in the purple category, in alphabetical order and use their first letter (e.g. DUODENUM-BULB = "D") to form the password. IMPORTANT: the first letters do not form an actual word.
  <details>The password here is 4 letters long.
  <summary>Length</summary></details>
</details>
...
<details> 
  ...
  <details> 
    ...
    The words are 5, 2, 4, 4 letters long. Remember you need to enter them in full caps without spaces.
  </details>
</details>
